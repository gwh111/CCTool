...
@interface UIAlertView(CC_ICInfomationView_Runtime)
-(void)setClickBlock:(ClickAtIndexBlock)block;
-(ClickAtIndexBlock)clickBlock;
@end

@implementation UIAlertView(CC_ICInfomationView_Runtime)
-(void)setClickBlock:(ClickAtIndexBlock)block{
...
@interface CC_ICInfomationView_Runtime ()<UIAlertViewDelegate>

@end

@implementation CC_ICInfomationView_Runtime
